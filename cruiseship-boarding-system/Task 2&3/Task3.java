...
class cabin{
    ...
    class passenger{
        ...
        public void Expenses(String[] passenger, int passengerCount) {
            ...
            System.out.println("Enter the passenger count to get expenses: ");
    ...
    public class Task3 {
        ...
        static int size = 4;                                 //size of the queue is set to 4
        public static int front, rear;                       // tracking the first and the last element
        public static String items[] = new String[size];
        ...
        boolean isFull() {                                      //checking if the queue is full
        ...
        //inserting customers to the queue
        ...
        //deleting a cabin and adding the next in the waiting list
        ...
        public static void Store(String[] ship, int cabinNum){
            try{
                FileWriter fw = new FileWriter("storing.txt",true);
                for(int i = 0; i < ship.length; i++){
                    PrintWriter pw = new PrintWriter(fw);
                    pw.print("The customer name and the cabin number is: " + ship[cabinNum] + " , " + i + ".\n");
                    pw.close();
                }
